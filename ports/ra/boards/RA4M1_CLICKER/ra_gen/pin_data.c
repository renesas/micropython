...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = {
	...
	},
	{
		...
		.pin_cfg = ((uint32_t) IOPORT_CFG_IRQ_ENABLE | (uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW | (uint32_t) IOPORT_CFG_PULLUP_ENABLE),
	},
	{

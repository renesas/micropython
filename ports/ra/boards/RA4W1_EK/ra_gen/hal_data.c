...
const timer_cfg_t g_timer1_cfg = { .mode = TIMER_MODE_PERIODIC,
		/* Actual period: 0.002048 seconds. Actual duty: 50%. */.period_counts =
...
/* Baud rate calculated with 2.124% error. */.abcse = 0, .abcs = 0, .bgdm = 1,
		.cks = 0, .brr = 16, .mddr = (uint8_t) 256, .brme = false };
